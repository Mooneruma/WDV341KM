...
<?php 
	...
	{	
		...
		if($validForm == true){
			...
			$stmt = $conn->prepare("UPDATE final_event SET event_name = '$inName', 
				event_description = '$inDesc', event_presenter = '$inPres', 
				event_date = '$inDate', event_time = '$inTime', event_price = '$inPrice' WHERE event_id = $UpdateEventId");
...
<nav class="navbar navbar-default">
  <div class="container-fluid">
	...
	$stmt = $conn->prepare("SELECT event_id, event_name, event_description, event_presenter, event_date, event_time, event_price FROM final_event WHERE event_id = $UpdateEventId");
	$stmt->execute();
?>
...
<div id="orderArea">
  ...
  <table width= 75% border="0">
    ...
    <tr>
      <td>Event Price: </td>
      <td><input type="" name="number" id="inPrice" size="50" value = "<?php echo $PresetPrice; ?>" /></td>
      <td class="error"></td>
    </tr>
 </table>
  <p>
