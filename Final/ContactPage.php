...
<?php 
	...
	{	
		...
		$contactEmail->setSubject($inName);
	
		$contactEmail->setMessage($inDesc);
...
<nav class="navbar navbar-default">
  ...
  <h3>Please leave us your comments or info</h3>	
  <table width="800" border="0">
    <tr>
      <td width="117">Subject:<input type="text" name="inName" id="inName" size="50" value = "<?php echo htmlspecialchars($inName); ?>" /><br><br></td>
    </tr>
    <tr>
      <td>Comment:<br><input type="text" name="inDesc" id="inDesc" size="50" value = "<?php echo htmlspecialchars($inDesc); ?>" /></td>
    </tr>
 </table>
  <p>
	...
	?>			
		<h2>Message delivery has encountered a problem</h2>
	<?php			
		}}
	?>
